...
class WrapperTabletExtraLargeView extends ConsumerStatefulWidget {
  const WrapperTabletExtraLargeView({super.key});

  @override
  ConsumerState<WrapperTabletExtraLargeView> createState() =>
      _WrapperTabletExtraLargeViewState();
}

class _WrapperTabletExtraLargeViewState
    extends ConsumerState<WrapperTabletExtraLargeView> {
  @override
