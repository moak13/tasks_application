...
class WrapperTabletLargeView extends ConsumerStatefulWidget {
  const WrapperTabletLargeView({super.key});

  @override
  ConsumerState<WrapperTabletLargeView> createState() =>
      _WrapperTabletLargeViewState();
}

class _WrapperTabletLargeViewState
    extends ConsumerState<WrapperTabletLargeView> {
  @override
