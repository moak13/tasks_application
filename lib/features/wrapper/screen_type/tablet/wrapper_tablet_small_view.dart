...
class WrapperTabletSmallView extends ConsumerStatefulWidget {
  const WrapperTabletSmallView({super.key});

  @override
  ConsumerState<WrapperTabletSmallView> createState() =>
      _WrapperTabletSmallViewState();
}

class _WrapperTabletSmallViewState
    extends ConsumerState<WrapperTabletSmallView> {
  @override
