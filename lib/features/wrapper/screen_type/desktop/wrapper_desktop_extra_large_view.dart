...
class WrapperDesktopExtraLargeView extends ConsumerStatefulWidget {
  const WrapperDesktopExtraLargeView({super.key});

  @override
  ConsumerState<WrapperDesktopExtraLargeView> createState() =>
      _WrapperDesktopExtraLargeViewState();
}

class _WrapperDesktopExtraLargeViewState
    extends ConsumerState<WrapperDesktopExtraLargeView> {
  @override
