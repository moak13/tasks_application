...
class WrapperDesktopSmallView extends ConsumerStatefulWidget {
  const WrapperDesktopSmallView({super.key});

  @override
  ConsumerState<WrapperDesktopSmallView> createState() =>
      _WrapperDesktopSmallViewState();
}

class _WrapperDesktopSmallViewState
    extends ConsumerState<WrapperDesktopSmallView> {
  @override
