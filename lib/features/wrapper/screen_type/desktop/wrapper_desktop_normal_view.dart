...
class WrapperDesktopNormalView extends ConsumerStatefulWidget {
  const WrapperDesktopNormalView({super.key});

  @override
  ConsumerState<WrapperDesktopNormalView> createState() =>
      _WrapperDesktopNormalViewState();
}

class _WrapperDesktopNormalViewState
    extends ConsumerState<WrapperDesktopNormalView> {
  @override
