...
class WrapperMobileExtraLargeView extends ConsumerStatefulWidget {
  const WrapperMobileExtraLargeView({super.key});

  @override
  ConsumerState<WrapperMobileExtraLargeView> createState() =>
      _WrapperMobileExtraLargeViewState();
}

class _WrapperMobileExtraLargeViewState
    extends ConsumerState<WrapperMobileExtraLargeView> {
  @override
