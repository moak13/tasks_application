...
class WrapperMobileNormalView extends ConsumerStatefulWidget {
  const WrapperMobileNormalView({super.key});

  @override
  ConsumerState<WrapperMobileNormalView> createState() =>
      _WrapperMobileNormalViewState();
}

class _WrapperMobileNormalViewState
    extends ConsumerState<WrapperMobileNormalView> {
  @override
