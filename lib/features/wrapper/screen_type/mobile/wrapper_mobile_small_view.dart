...
class WrapperMobileSmallView extends ConsumerStatefulWidget {
  const WrapperMobileSmallView({super.key});

  @override
  ConsumerState<WrapperMobileSmallView> createState() =>
      _WrapperMobileSmallViewState();
}

class _WrapperMobileSmallViewState
    extends ConsumerState<WrapperMobileSmallView> {
  @override
