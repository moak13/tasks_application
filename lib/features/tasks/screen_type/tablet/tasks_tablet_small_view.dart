...
class TasksTabletSmallView extends ConsumerStatefulWidget {
  const TasksTabletSmallView({super.key});

  @override
  ConsumerState<TasksTabletSmallView> createState() =>
      _TasksTabletSmallViewState();
}

class _TasksTabletSmallViewState extends ConsumerState<TasksTabletSmallView> {
  @override
