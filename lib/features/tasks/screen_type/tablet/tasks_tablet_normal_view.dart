...
class TasksTabletNormalView extends ConsumerStatefulWidget {
  const TasksTabletNormalView({super.key});

  @override
  ConsumerState<TasksTabletNormalView> createState() =>
      _TasksTabletNormalViewState();
}

class _TasksTabletNormalViewState extends ConsumerState<TasksTabletNormalView> {
  @override
