...
class TasksTabletExtraLargeView extends ConsumerStatefulWidget {
  const TasksTabletExtraLargeView({super.key});

  @override
  ConsumerState<TasksTabletExtraLargeView> createState() =>
      _TasksTabletExtraLargeViewState();
}

class _TasksTabletExtraLargeViewState
    extends ConsumerState<TasksTabletExtraLargeView> {
  @override
