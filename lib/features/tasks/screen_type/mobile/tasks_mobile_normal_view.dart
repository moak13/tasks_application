...
class TasksMobileNormalView extends ConsumerStatefulWidget {
  const TasksMobileNormalView({super.key});

  @override
  ConsumerState<TasksMobileNormalView> createState() =>
      _TasksMobileNormalViewState();
}

class _TasksMobileNormalViewState extends ConsumerState<TasksMobileNormalView> {
  @override
